...
mod tests_regular {
    ...
    ) -> ValidatorGroupMap<CertificateSignaturePubKey<SignatureType>> {
...
mod tests_deterministic {
    ...
    use crate::{
        ...
        util::{
            BroadcastMode, BuildTarget, FullNodeGroupMap, PrimaryBroadcastGroup, UdpMessage,
            ValidatorGroupMap,
        },
    };
    ...
    fn build_packets(
        key: &KeyPairType,
        app_message: &[u8],
        group: PrimaryBroadcastGroup<'_, CertificateSignaturePubKey<SignatureType>>,
